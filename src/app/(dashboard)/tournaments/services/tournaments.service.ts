...
### COMMIT 2 — TournamentCard: componente de card de torneo

```
Crea el archivo src/common/components/TournamentCard.tsx con este contenido:
        ...
        >
            ...
            <div className="relative z-20 p-8 space-y-2 h-full flex flex-col justify-between">
                <div className="flex justify-between items-start">
                    <span className={`text-[10px] font-bold uppercase tracking-widest ${statusStyles[tournament.status] ?? 'text-[#A1A1A1]'}`}>
